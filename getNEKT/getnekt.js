window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'getNEKT/';
    const productsRow = document.getElementById('getnekt');
    const toggleBtn = document.getElementById('toggleBtn_getnekt');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'getNEKT/getnekt.json';
