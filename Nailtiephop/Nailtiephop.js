window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'Nailtiephop/';
    const productsRow = document.getElementById('Nailtiephop');
    const toggleBtn = document.getElementById('toggleBtn_Nailtiephop');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'Nailtiephop/Nailtiephop.json';
