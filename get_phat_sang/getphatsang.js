window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'get_phat_sang/';
    const productsRow = document.getElementById('getphatsang');
    const toggleBtn = document.getElementById('toggle_getphatsang');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'get_phat_sang/getphatsang.json';
