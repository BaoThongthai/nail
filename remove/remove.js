window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'remove/';
    const productsRow = document.getElementById('remove');
    const toggleBtn = document.getElementById('toggleBtn_remove');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'remove/remove.json';
                ...
                const productHTML = `
                    <div class="col-md-4 col-sm-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <h5 class="card-title"> Name : ${imageNameWithoutExtension}</h5>
