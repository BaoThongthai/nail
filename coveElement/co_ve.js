window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'co_ve/';
    const productsRow = document.getElementById('Co_ve');
    const toggleBtn = document.getElementById('toggleBtn_cove');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'coveElement/co_ve.json';
