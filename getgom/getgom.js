window.addEventListener('DOMContentLoaded', () => {
    const folderPath = 'getgom/';
    const productsRow = document.getElementById('getgom');
    const toggleBtn = document.getElementById('toggleBtn_getgom');
    let showAllProducts = false;

    // Đường dẫn đến tập tin JSON chứa danh sách tên tệp ảnh
    const jsonFilePath = 'getgom/getgom.json';
